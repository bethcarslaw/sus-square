...
const Privacy: NextPage = () => (
  <div className="policy-doc">
    ...
    <p>
      <strong>Last updated October 21, 2022</strong>
    </p>
    <p>
      This privacy notice for Suffer Under Sorrow ( &#39;&nbsp;{" "}
    ...
    <ul>
      <li>
        ...
        <a href="http://www.sufferundersorrow.com/">
          http://www.sufferundersorrow.com
        </a>
    ...
    <p>
      ...
      depending on how you interact with Suffer Under Sorrow and the Services,
    ...
    <p>
      ...
      Click&nbsp; <a href="#infouse">here</a>&nbsp;to learn more.
    </p>
    <p>
      <strong>
      ...
      parties. Click&nbsp; <a href="#whoshare">here</a>
      &nbsp;to learn more.
    </p>
    <p>
      ...
      Click&nbsp; <a href="#infosafe">here</a>&nbsp;to learn more.
    </p>
    <p>
    ...
    <p>
      ...
      available&nbsp;{" "}
      <a
        href="https://app.termly.io/notify/3a3093e2-a6a9-4c9b-9e72-c14383e5fcd7"
    ...
    <p>
      Want to learn more about what Suffer Under Sorrow does with any
      information we collect? Click&nbsp; <a href="#toc">here</a>&nbsp;to review
      the notice in full.{" "}
    </p>
    <p>
    ...
    <p>
      ...
      instrument. All payment data is stored by Square . You may find their
      privacy notice link(s) here:&nbsp;{" "}
      <a href="https://squareup.com/gb/en/legal/general/privacy">
    ...
    <ul>
      <li>
        ...
        Click&nbsp; <a href="#withdrawconsent">here</a>
        &nbsp;to learn more.
      </li>
    </ul>
    <ul>
    ...
    <p>
      ...
      <u>&nbsp;</u>You can unsubscribe from our marketing and promotional
      communications at any time by clicking on the unsubscribe link in the
      emails that we send, or by contacting us using the details provided in the
      section &#39;{" "}
      <a href="#contact">HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</a>
    ...
    <p>
      ...
      us at contact@sufferundersorrow.com.
    </p>
    <p>
    ...
    <p>
      You may contact us by email at contact@sufferundersorrow.com, by
      visiting&nbsp;{" "}
      <a href="http://www.sufferundersorrow.com/contact">
        http://www.sufferundersorrow.com/contact
      </a>
      , or by referring to the contact details at the bottom of this document.{" "}
    </p>
    <p>
      If you are using an authorised agent to exercise your right to opt out we
      may deny a request if the authorised agent does not submit proof that they
    ...
    <p>
      Suffer Under Sorrow has not disclosed or sold any personal information to
      third parties for a business or commercial purpose in the preceding twelve
      (12) months. Suffer Under Sorrow will not sell personal information in the
    ...
    <p>
      ...
      contact@sufferundersorrow.com, by visiting&nbsp;{" "}
      <a href="http://www.sufferundersorrow.com/contact">
        http://www.sufferundersorrow.com/contact
      </a>
      , or by referring to the contact details at the bottom of this document.
    ...
    <p>
      ...
      contact@sufferundersorrow.com or via the contact form found{" "}
      <a href="https://www.sufferundersorrow.com/contact">here</a>.
    </p>
    <p>
      <strong>
        14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
